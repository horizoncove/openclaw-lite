...
export default function AllianceOrdersPage() {
  const { orders, upsertOrder } = useAllianceStore();
  ...
  const create = () => {
    ...
    const id = `AL-2026-${String(orders.length + 3).padStart(3, "0")}`;

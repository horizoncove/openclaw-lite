...
| [`docs/PRD.md`](./docs/PRD.md) | 需求：参与者、范围、用户故事 |
| [`docs/TECH.md`](./docs/TECH.md) | 技术：模型、API、持久化 |
| [`docs/MVP-VALIDATION.md`](./docs/MVP-VALIDATION.md) | 验收脚本与报告模板 |
...
|------|------|
| 官网落地页 | 双入口、产品介绍 |
| 联盟运行 | 会员、活动、供需撮合、作品/场地、**生态闭环（成交开预算/分账）** |
| 会员门户 | 供需、作品、推荐、**项目钱包** |
| 五大中心 | 审批/出海/发行/版权/AI、全景看板、Token 聚合 |

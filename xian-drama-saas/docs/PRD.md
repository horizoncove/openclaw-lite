...
2. **供需撮合**：发布（含支付机制）/ 供应方应征改条款 / 状态流转 / 建议供给方 + 场景包  
...
**作为**需求方会员，**我希望**发布供需时设定预付 / 过程支付 / 验收后支付，**以便**按自己的资金节奏开单。

**作为**供给方会员，**我希望**应征时接受或要求改变支付机制，**以便**保障开工资金或对齐验收节奏。

**作为**秘书处运营，**我希望**对一条「开放/撮合中」供需选择供给方、场景包与最终支付机制（或采纳应征）并成交，**以便**立刻按机制冻结首笔托管并生成履约项目。

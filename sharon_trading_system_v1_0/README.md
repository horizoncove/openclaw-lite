...
- PDF 规定的四大体系：SOP 选股、纪律执行、AI 监督、账户数据
- 七星 SOP 评分、STRICT/NOISE/REJECT 分类和判断依据留档
- 交易前红黄绿测算，SOP 不合格、硬红线和禁买时段自动拦截
...
- 账户总览、持仓、交易流水、风险、SOP、计划、监督、复盘和任务界面

金额统一以人民币元写入数据库，界面以“万元”显示。PDF 基准为起始资金 5,000,000 元、当前总额 5,037,175.21 元、累计盈亏 37,175.21 元。

> PDF 是系统索引，没有列出七星的七个具体名称和“五种强制空仓情况”。软件将七项评分保留为可配置占位项，不会凭空编造投资规则；拿到被索引的 SOP 和纪律手册后可替换名称与条件。

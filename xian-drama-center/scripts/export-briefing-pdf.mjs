/**
 * Export the briefing proposal HTML to PDF.
 */
...
const HTML = path.join(ROOT, "docs", "汇报方案.html");
const OUT_ARTIFACT =
  process.env.PDF_OUT ||
  "/opt/cursor/artifacts/xian-weiduanju-briefing-proposal.pdf";
const OUT_REPO = path.join(ROOT, "docs", "西安微短剧产业服务中心建设汇报方案.pdf");
